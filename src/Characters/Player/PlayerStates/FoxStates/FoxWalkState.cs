...
public partial class FoxWalkState : PlayerBaseState, ICharacterState
{
    ...
    public override Const.CharactersEnums.States StateName { get; set; } = Const.CharactersEnums.States.FOX_WALK_STATE;
    ...
    private void PlayWalkAnimation()
    {
        ...
        {
            _animPlayer.Play("fox_run_in_place");
    ...
    private void TransitionToIdle()
    {
        ...
        {
            EmitStateTransition(this, Const.CharactersEnums.States.FOX_IDLE_STATE, _charMainNode);//Const.CharacterStates.States.PLAYER_IDLE_STATE, _characterNode);
