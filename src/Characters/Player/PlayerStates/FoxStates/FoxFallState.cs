...
{
    public override Const.CharactersEnums.States StateName { get; set; } = Const.CharactersEnums.States.FOX_FALL_STATE;
    ...
    private void TransitionToIdle(double delta)
    {
        ...
        {
            EmitStateTransition(this, Const.CharactersEnums.States.FOX_IDLE_STATE, _charMainNode);
        }
